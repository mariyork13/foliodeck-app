# Перенос foliodeck-app на Yandex Cloud (РФ)

Цель: публичный сайт на `foliodeck.pro` с приложением, базой и картинками
на российской инфраструктуре. LMS (`lms-career`) не затрагивается.
