...
// Fifth example student — Катя Чещевая. Editable afterwards in the admin form.
const designer = {
  slug: "katya-cheschevaya",
  first_name: "Катя",
  last_name: "Чещевая",
  cover_image: null as string | null, // TODO: add a cover image URL in the editor
  grade: "Middle+",
  years_of_experience: 4, // "3,5 годами"
  open_to_work: true,
};

const taxonomy: Record<string, string[]> = {
  platform: ["Web", "Mobile", "iOS", "Android"],
  business_model: ["B2C", "B2B", "B2E"],
  industry: ["HealthTech"],
  interface_type: ["Data-heavy interfaces"],
  skill: ["Design systems", "Research", "Mobile design", "UI", "Web design"],
  company_type: ["Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/eachesh" }];
