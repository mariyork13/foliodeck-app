...
// Fifteenth example student — Евгения Кузенкова. Editable afterwards in the admin form.
const designer = {
  slug: "evgenia-kuzenkova",
  first_name: "Евгения",
  last_name: "Кузенкова",
...
const newTerms: [string, string][] = [["industry", "Crypto / Web3"]];

const taxonomy: Record<string, string[]> = {
  platform: ["Web", "Mobile", "iOS", "Android", "Telegram Mini Apps"],
  business_model: ["B2C", "B2B"],
  industry: ["Fintech", "Crypto / Web3", "HealthTech", "EdTech"],
...
const links = [{ type: "telegram", url: "https://t.me/jane_kuzenkova" }];
