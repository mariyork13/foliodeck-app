...
// Seventeenth example student — Анастасия Князева. Editable afterwards in the admin form.
const designer = {
  slug: "anastasia-knyazeva",
...
const newTerms: [string, string][] = [
  ["interface_type", "Low-code platforms"],
  ["interface_type", "Service Desk"],
];

const taxonomy: Record<string, string[]> = {
  platform: ["Web"],
  business_model: ["B2B", "B2G", "B2E"],
  industry: ["GovTech", "Fintech", "Productivity"],
  interface_type: ["CRM", "Admin panels", "Data-heavy interfaces", "Low-code platforms", "Service Desk"],
  skill: ["Data-heavy interfaces", "Research", "UI", "Web design", "Design systems"],
  company_type: ["BigTech"],
};

const links = [{ type: "telegram", url: "https://t.me/avkdes" }];
