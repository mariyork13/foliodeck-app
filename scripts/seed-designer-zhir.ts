...
// Thirty-seventh example student — Анна Жир. Editable afterwards in the admin form.
const designer = {
  slug: "anna-zhir",
  first_name: "Анна",
  last_name: "Жир",
...
// Figma file title "Мобилки 2"; year 2026 inferred from the same cohort — verify.
const programs = [{ program: "Мобилки", cohort: "2", year: 2026 }];

const links = [
  {
    type: "figma",
    url: "https://www.figma.com/design/vattPn27KXjSje3t81nwjS/Жир-Анна-|-Мобилки-2?node-id=118-2524&t=fVEOaOEKzKARQTRu-1",
  },
  { type: "telegram", url: "https://t.me/anya_zhir" },
];
