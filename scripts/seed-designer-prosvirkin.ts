...
// Fourteenth example student — Кирилл Просвиркин. Editable afterwards in the admin form.
const designer = {
  slug: "kirill-prosvirkin",
  first_name: "Кирилл",
  last_name: "Просвиркин",
...
const taxonomy: Record<string, string[]> = {
  ...
  industry: ["Productivity", "GovTech"],
  interface_type: ["ERP", "Admin panels", "Dashboards", "Data-heavy interfaces"],
  skill: ["Design systems", "Data-heavy interfaces", "Web design", "UI", "Research"],
  company_type: ["Startup", "Agency"],
};

const links = [{ type: "telegram", url: "https://t.me/prosvirkink" }];
