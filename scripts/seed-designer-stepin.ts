...
// Twenty-fifth example student — Александр Стёпин. Editable afterwards in the admin form.
const designer = {
  slug: "alexander-stepin",
...
const links = [{ type: "telegram", url: "https://t.me/stepinaleks" }];
