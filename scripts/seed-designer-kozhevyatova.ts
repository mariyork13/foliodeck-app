...
// Thirty-ninth example student — Екатерина Кожевятова. Editable afterwards in the admin form.
const designer = {
  slug: "ekaterina-kozhevyatova",
  first_name: "Екатерина",
  last_name: "Кожевятова",
...
// Figma title says "Поток 2"; program "Мобилки" and year 2026 inferred from the cohort — verify.
const programs = [{ program: "Мобилки", cohort: "2", year: 2026 }];

const links = [
  { type: "dribbble", url: "https://dribbble.com/katy_orl" },
  { type: "linkedin", url: "https://www.linkedin.com/in/katerina-kozheviatova-5885253b0/" },
  {
    type: "figma",
    url: "https://www.figma.com/design/ZWn0roZhXNge8KS1i2Sio0/Кожевятова-Е.-Поток-2?node-id=1441-11051&t=AhdPyYLRKqXZSGuY-4",
  },
  { type: "telegram", url: "https://t.me/katy_or" },
];
