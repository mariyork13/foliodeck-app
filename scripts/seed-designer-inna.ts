...
// Sixth example student — Инна Иванова. Editable afterwards in the admin form.
const designer = {
  slug: "inna-ivanova",
  first_name: "Инна",
  last_name: "Иванова",
...
const taxonomy: Record<string, string[]> = {
  ...
  business_model: ["B2B", "B2E", "B2C"],
  industry: ["EdTech", "E-commerce", "Logistics"],
  interface_type: ["Admin panels", "Data-heavy interfaces"],
  skill: ["Research", "Mobile design", "Web design", "UI"],
  company_type: ["BigTech", "Government company"],
};

const links = [{ type: "telegram", url: "https://t.me/innarenard" }];
