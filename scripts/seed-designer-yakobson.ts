...
// Eleventh example student — Инна Якобсон. Editable afterwards in the admin form.
const designer = {
  slug: "inna-yakobson",
  first_name: "Инна",
  last_name: "Якобсон",
...
const taxonomy: Record<string, string[]> = {
  ...
  interface_type: [],
  skill: ["Research", "UI", "Mobile design", "Web design"],
  company_type: ["Agency"],
};

const links = [{ type: "telegram", url: "https://t.me/inna_yakobson" }];
