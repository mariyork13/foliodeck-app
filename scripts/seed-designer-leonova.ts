...
// Thirty-eighth example student — Анна Леонова. Editable afterwards in the admin form.
const designer = {
  slug: "anna-leonova",
  first_name: "Анна",
  last_name: "Леонова",
...
// "Мобилки 2" from the Figma title; year 2026 inferred from the same cohort — verify.
const programs = [{ program: "Мобилки", cohort: "2", year: 2026 }];

const links = [
  {
    type: "figma",
    url: "https://www.figma.com/design/GzmxC72rvXT6qQvAAgyjXG/Леонова-Анна-|-Мобилки-2?node-id=1451-15712",
  },
  { type: "dribbble", url: "https://dribbble.com/AnLeon" },
  { type: "linkedin", url: "https://www.linkedin.com/in/anna-leonova-614481282/" },
  { type: "telegram", url: "https://t.me/Sweet_Chamomile" },
];
