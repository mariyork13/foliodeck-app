...
// Nineteenth example student — Татьяна Шерстнева. Editable afterwards in the admin form.
const designer = {
  slug: "tatiana-sherstneva",
  first_name: "Татьяна",
  last_name: "Шерстнева",
...
const taxonomy: Record<string, string[]> = {
  ...
  industry: ["Fintech", "EdTech", "Productivity"],
  interface_type: ["CRM", "Admin panels", "Dashboards", "Data-heavy interfaces"],
  skill: ["Data-heavy interfaces", "Research", "UI", "Web design"],
  company_type: ["Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/Tatanny" }];
