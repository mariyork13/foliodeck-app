...
// Thirty-third example student — Карина Харченко. Editable afterwards in the admin form.
const designer = {
  slug: "karina-kharchenko",
  first_name: "Карина",
  last_name: "Харченко",
...
const links = [{ type: "telegram", url: "https://t.me/locopintora" }];
