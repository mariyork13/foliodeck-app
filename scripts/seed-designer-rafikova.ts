...
// Thirteenth example student — Дина Рафикова. Editable afterwards in the admin form.
const designer = {
  slug: "dina-rafikova",
  first_name: "Дина",
  last_name: "Рафикова",
  ...
  grade: "Middle",
  years_of_experience: 2, // "2+ годами"
  open_to_work: true,
};

const taxonomy: Record<string, string[]> = {
  platform: ["Web", "Mobile"],
  business_model: ["B2E", "B2C", "B2B"],
  industry: ["Telecom", "Productivity", "AI"],
  interface_type: ["Data-heavy interfaces", "Admin panels"],
  skill: ["Research", "Data-heavy interfaces", "Web design", "UI", "AI"],
  company_type: ["BigTech", "Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/totalitaro4ka" }];
