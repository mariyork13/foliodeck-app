...
// Twenty-fourth example student — Денис Лыкин. Editable afterwards in the admin form.
const designer = {
  slug: "denis-lykin",
  first_name: "Денис",
  last_name: "Лыкин",
...
const links = [
  { type: "portfolio", url: "https://denislykin.ru" },
  { type: "telegram", url: "https://t.me/denyalykin" },
];
