...
// Twenty-eighth example student — Саша Селиванов. Editable afterwards in the admin form.
// Note: just accepted an offer — not currently looking. Portfolio in progress.
const designer = {
  slug: "sasha-selivanov",
  first_name: "Саша",
  last_name: "Селиванов",
  cover_image: null as string | null,
  grade: "Junior", // not stated
  years_of_experience: null as number | null,
  open_to_work: false, // just accepted an offer
};

const links = [{ type: "telegram", url: "https://t.me/freeassist" }];
