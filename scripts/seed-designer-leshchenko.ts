...
// Thirty-second example student — Данил Лещенко. Editable afterwards in the admin form.
const designer = {
  slug: "danil-leshchenko",
  first_name: "Данил",
  last_name: "Лещенко",
...
const links = [{ type: "telegram", url: "https://t.me/Danil_Leshenko" }];
