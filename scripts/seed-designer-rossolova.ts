...
// Fortieth example student — Ангелина Россолова. Editable afterwards in the admin form.
const designer = {
  slug: "angelina-rossolova",
  first_name: "Ангелина",
  last_name: "Россолова",
...
const programs = [{ program: "Мобилки", cohort: "2", year: 2026 }]; // "Мобилки 2" from Figma

const links = [
  {
    type: "figma",
    url: "https://www.figma.com/design/TiXyeDWBRG0XlrybbY6ot1/Россолова-Ангелина-|-Мобилки-2?node-id=707-9015&t=Wto2j2stvmxRgXSf-4",
  },
  { type: "linkedin", url: "https://www.linkedin.com/in/rossolovaang/" },
  { type: "dribbble", url: "https://dribbble.com/rossolovaang" },
  { type: "telegram", url: "https://t.me/rossolovaang" },
];
