...
// Sixteenth example student — Мария Воронцова. Editable afterwards in the admin form.
const designer = {
  slug: "maria-vorontsova",
  first_name: "Мария",
  last_name: "Воронцова",
  cover_image: null as string | null, // TODO: add a cover image URL in the editor
  grade: "Middle",
  years_of_experience: 2, // "2+" in product design (10+ yrs visual/communication design overall)
  open_to_work: true,
};
...
const taxonomy: Record<string, string[]> = {
  ...
  business_model: ["B2C"],
  industry: ["EdTech", "Media", "Entertainment"],
  interface_type: [],
  skill: ["UI", "Web design", "Mobile design", "Research", "Graphic design"],
  company_type: ["Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/vasha_masha_v" }];
