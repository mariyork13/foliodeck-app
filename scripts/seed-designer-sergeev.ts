...
// Seventh example student — Евгений Сергеев. Editable afterwards in the admin form.
const designer = {
  slug: "evgeny-sergeev",
  first_name: "Евгений",
  last_name: "Сергеев",
  ...
  open_to_work: false, // no "Открыт к" section in the source profile
};
...
const taxonomy: Record<string, string[]> = {
  ...
  interface_type: [],
  skill: ["Web design", "Mobile design", "UI", "Research"],
  company_type: ["Small business"],
};

const links = [{ type: "telegram", url: "https://t.me/EvgSrgk14" }];
