...
// Twenty-third example student — Артём Набоков. Editable afterwards in the admin form.
const designer = {
  slug: "artem-nabokov",
  first_name: "Артём",
  last_name: "Набоков",
...
const links = [
  { type: "portfolio", url: "https://bankas1dra.github.io/portfolio/" },
  { type: "telegram", url: "https://t.me/bankasidra" },
];
