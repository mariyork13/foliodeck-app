...
// Fourth example student — Борис Чубин. Editable afterwards in the admin form.
const designer = {
  slug: "boris-chubin",
  first_name: "Борис",
  last_name: "Чубин",
...
const newTerms: [string, string][] = [["skill", "Graphic design"]];

const taxonomy: Record<string, string[]> = {
  platform: ["Web", "Mobile", "iOS", "Android"],
  business_model: ["B2C", "B2B"],
  industry: ["E-commerce", "Social", "Cybersecurity", "Productivity"],
  interface_type: [],
  skill: ["UI", "Web design", "Mobile design", "Graphic design"],
  company_type: ["BigTech", "Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/MilordDesigner" }];
