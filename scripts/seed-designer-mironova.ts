...
// Twenty-ninth example student — Наташа Миронова. Editable afterwards in the admin form.
// Note: started at a startup ~2 months ago (Spain-based) — not currently looking.
const designer = {
  slug: "natasha-mironova",
  first_name: "Наташа",
  last_name: "Миронова",
  cover_image: null as string | null,
  grade: "Middle", // not stated
  years_of_experience: null as number | null,
  open_to_work: false, // recently joined a startup
};
...
const taxonomy: Record<string, string[]> = {
  ...
  industry: [],
  interface_type: [],
  skill: ["Live coding / Vibe coding", "AI"],
  company_type: ["Startup"],
};

const links = [
  { type: "portfolio", url: "https://mironova-portfolio.vercel.app/" },
  { type: "telegram", url: "https://t.me/mironake" },
];
