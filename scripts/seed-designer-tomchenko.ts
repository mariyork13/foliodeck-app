...
// Eighth example student — Света Томченко. Editable afterwards in the admin form.
const designer = {
  slug: "sveta-tomchenko",
  first_name: "Света",
  last_name: "Томченко",
  cover_image: null as string | null, // TODO: add a cover image URL in the editor
  grade: "Middle",
  years_of_experience: 3, // "2,5 годами"
  open_to_work: true,
};

const newTerms: [string, string][] = [["platform", "Telegram Mini Apps"]];

const taxonomy: Record<string, string[]> = {
  platform: ["Web", "Mobile", "iOS", "Android", "Desktop", "Telegram Mini Apps"],
  business_model: ["B2B", "B2C"],
  industry: ["Fintech", "HealthTech", "AI", "Productivity"],
  interface_type: ["CRM", "ERP", "AI interfaces", "Data-heavy interfaces"],
  skill: ["AI", "Research", "UI", "Web design", "Mobile design", "Data-heavy interfaces"],
  company_type: ["Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/sladkii_trevozhnick" }];
