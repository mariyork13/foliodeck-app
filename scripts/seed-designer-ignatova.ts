...
// Eighteenth example student — Евгения Игнатова. Editable afterwards in the admin form.
const designer = {
  slug: "evgenia-ignatova",
  first_name: "Евгения",
  last_name: "Игнатова",
...
const taxonomy: Record<string, string[]> = {
  platform: ["Web", "Mobile", "iOS", "Android", "Telegram Mini Apps"],
  business_model: ["B2C", "B2E", "B2B"],
  industry: ["Fintech", "Telecom", "Social", "AI"],
  interface_type: ["Admin panels", "AI interfaces"],
  skill: ["Mobile design", "Web design", "UI", "Research", "AI"],
  company_type: ["BigTech"],
};

const links = [{ type: "telegram", url: "https://t.me/ignatova_jane" }];
