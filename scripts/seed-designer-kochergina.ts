...
// Thirty-first example student — Дарья Кочергина. Editable afterwards in the admin form.
const designer = {
  slug: "darya-kochergina",
  first_name: "Дарья",
  last_name: "Кочергина",
...
const links = [{ type: "telegram", url: "https://t.me/dakochergina" }];
