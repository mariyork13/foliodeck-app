...
// Third example student — Арина Мартель. Editable afterwards in the admin form.
const designer = {
  slug: "arina-martel",
  first_name: "Арина",
  last_name: "Мартель",
...
const taxonomy: Record<string, string[]> = {
  ...
  industry: ["TravelTech"],
  interface_type: ["ERP", "CRM", "Data-heavy interfaces"],
  skill: ["Design systems", "UI", "Web design", "Mobile design"],
  company_type: ["Agency", "Startup"],
};

const links = [{ type: "telegram", url: "https://t.me/miurunie" }];
