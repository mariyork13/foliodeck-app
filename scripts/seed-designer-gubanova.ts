...
// Twelfth example student — Анастасия Губанова. Editable afterwards in the admin form.
const designer = {
  slug: "anastasia-gubanova",
...
const taxonomy: Record<string, string[]> = {
  ...
  industry: ["Social", "HRTech", "AI", "Entertainment"],
  interface_type: ["Data-heavy interfaces", "AI interfaces"],
  skill: ["Mobile design", "Web design", "UI", "Research"],
  company_type: ["BigTech", "Startup", "Agency"],
};

const links = [{ type: "telegram", url: "https://t.me/GubanovaDes" }];
