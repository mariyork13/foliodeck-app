    ...
    <>
      ...
      <div className="space-y-4 text-base text-white/60">
        <p>
          ...
          years of industry experience. You can check out my own portfolio here too.
        </p>
        <p>
    ...
    <>
      ...
      <div className="space-y-4 text-base text-white/60">
        <p>
          ...
          опытом в индустрии. Здесь же можно посмотреть моё собственное портфолио.
        </p>
        <p>
        ...
        <p>И присылайте своё портфолио :)</p>
      </div>
    </>
  );
}
