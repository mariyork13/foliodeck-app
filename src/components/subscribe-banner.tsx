...
export function SubscribeBanner() {
  ...
  return (
    <div className="pointer-events-auto w-full sm:w-fit">
      ...
      <div className={`flex items-center gap-3 rounded-xl p-2.5 ${panelBg}`}>
        ...
        <a
          ...
          className="flex h-8 shrink-0 items-center gap-2 rounded-full bg-white pl-[10px] pr-[14px] text-[13px] font-medium text-black hover:bg-white/90"
        >
