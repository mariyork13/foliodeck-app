            ...
            <>
              ...
              {notesOpen && (
                <>
                  ...
                  <div
                    className={`absolute left-3 right-3 top-[calc(100%+16px)] z-50 max-h-[70vh] overflow-y-auto rounded-xl bg-[#1e1e21]/70 p-4 ${TEXT_SCALE} leading-relaxed text-white/80 backdrop-blur-[74px] sm:left-auto sm:w-80`}
                  >
                    {curator.notes}
                  </div>
                </>
